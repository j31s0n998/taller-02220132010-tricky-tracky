    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(140, 140, 140)
                .addComponent(labelVictoryX, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(labelX)
...
public void verifyWinner() {
    for (int[] combo : victory) {
        ...
        if (xWins) { // Si "x" gana
            ...
            labelVictoryX.setText("Victorias de X: " + puntuacionX); // Actualizar el marcador
        ...
        if (oWins) { // Si "o" gana
            ...
            labelVictoryO.setText("Victorias de O: " + puntuacionO); // Actualizar el marcador
